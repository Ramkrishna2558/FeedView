...
//     // Platform messages may fail, so we use a try/catch PlatformException.nirag
//     try {
...
//         await Starflut.copyFileFromAssets("python-3.10.4.zip",
...
//       StarObjectClass retobj = await python.call("create", [motionsensor.x,y, z]);
